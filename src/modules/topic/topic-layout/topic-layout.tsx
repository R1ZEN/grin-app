...
export const TopicLayout: React.FC<ITopicLayoutProps> = () => {
  return (
    <>
      ...
      <TopicDescription>Learn Design online comprehensively. Watch courses in web design, 3D animation, UI/UX app
        design, modeling, and many more. Find the best tutors in design for individual lessons. Or read
        straight-to-the-point stories about the world of design and creativity.</TopicDescription>
      ...
      <TopicFAQ list={[{ title: 'Title', content: ['Content'] }]} />
    </>
  );
};